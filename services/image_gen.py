...
class ImageGenerator:
    """Image generator using OpenRouter with reference images."""
    ...
    def _select_reference_images(self, count: int = 2) -> list[str]:
        """
        ...
        """
        all_images = self._get_reference_images()
    ...
    async def generate(self, prompt: str) -> bytes:
        ...
        reference_images = self._select_reference_images(2)
